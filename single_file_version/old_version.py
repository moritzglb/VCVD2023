...
#own modules
#from graph_export import exec_sample_plot_

#setup argparser
#based on
#source: https://docs.python.org/3/library/argparse.html
parser = argparse.ArgumentParser(description="Process some integers.")
#listing all call arguments of the program, consisting of mass, velocity, friction, inclination, lowest and highest angle and plot file name 
...
parser.add_argument("-a", "--inclination", type=int, default=10, help="inclination of surface in deg")
parser.add_argument("-d", "--low_angle", type=int, default=-90, help="sets the steepes descend angle to be calculated")
parser.add_argument("-u", "--high_angle", type=int, default=90, help="sets the steepes ascend angle to be calculated")
parser.add_argument("--pdf_file_out", type=str, default="example_plot", help="sets the file name for the plot .pdf export")
args = parser.parse_args()

#print out the chosen file name for the graph export 
print (args.pdf_file_out)
...
print (np.cos(args.low_angle), np.cos(args.high_angle), np.cos(incline))
...
#===============
#required stopping distance depending on angle of slope
...
plt.grid (True)
plt.subplot(2,2,2)
plt.plot (time, current_distance(time))
